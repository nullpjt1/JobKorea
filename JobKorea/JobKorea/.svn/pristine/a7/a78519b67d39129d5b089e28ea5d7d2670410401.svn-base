...
$(document).ready(function() { 
	...
	$('.btn_copjoin').click(function() {

	
		
		
		$.ajax({
			url : '/cop/officeReg.do',
			type : 'POST',
			
			async : false,
			success : function() {
				window.open('/cop/officeReg.do','officeReg','width=800, height=500, toolbar=no, menubar=no, scrollbars=no, resizable=yes, location=no ')
			...
			<div class="login_form"  align="center">
				<form id="myForm" action=""  method="post"  >
					<fieldset>
						...
						<br>
						  <a class="btn_usejoin" href="#" ><strong>[일반회원가입]</strong></a>
						  &nbsp;&nbsp;
