package kr.kosmo.jobkorea.dashboard.dto;
...
public class ProjectDTO {
	...
	public ProjectDTO(String projectId, String workarea, String work_type, String industry_type, String project_name, String reg_date,
	...
	public String toString() {
		return "AdmProjectDTO [workarea=" + workarea + ", work_type=" + work_type + ", industry_type=" + industry_type
