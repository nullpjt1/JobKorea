...
public class HoliMgrModel {
	// 날짜 
	private String cal_dt;
	// 공휴일 여부
	private String holi_poa;
	// 공휴일 명
	...
	/**
	 * @param cal_dt the cal_dt to set
	 */
	 ...
	 * @return the holi_poa
	 */
	public String getHoli_poa() {
		return holi_poa;
	}
	/**
	 * @param holi_poa the holi_poa to set
	 */
	public void setHoli_poa(String holi_poa) {
		this.holi_poa = holi_poa;
	}
	/**
	 * @return the holi_nm
	 */
	...
	/**
	 * @param holi_nm the holi_nm to set
	 */
